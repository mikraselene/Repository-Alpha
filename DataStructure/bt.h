...
#define COMPILE_ASSERT(expr, msg) \
    ...
    struct btree_common_params
    {
        ...
        typedef std::conditional<btree_is_key_compare_to<Compare>::value,
                                 Compare,
        ...
        typedef std::conditional<(kNodeValueSpace / ValueSize) >= 256,
                                 uint16_t,
                                 uint8_t>
            node_count_type;
    };
    ...
    public:
        ...
        typedef std::conditional<Params::is_key_compare_to::value,
        ...
        typedef std::conditional<std::is_integral<key_type>::value || std::is_floating_point<key_type>::value,
    ...
    class btree : public Params::key_compare
    {
        ...
        typedef std::conditional<is_key_compare_to::value,
