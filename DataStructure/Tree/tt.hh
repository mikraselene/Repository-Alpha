...
#pragma region // what is OK
	...
	post_order_iterator begin_post() const; // TODO:
	/// Return post-order end iterator of the tree.
	post_order_iterator end_post() const; // TODO:
	/// Return fixed-depth iterator to the first node at a given depth from the given iterator.
	fixed_depth_iterator begin_fixed(const iterator_base &, unsigned int) const; // TODO:
	/// Return fixed-depth end iterator.
	fixed_depth_iterator end_fixed(const iterator_base &, unsigned int) const; // TODO:
	/// Return breadth-first iterator to the first node at a given depth.
	breadth_first_queued_iterator begin_breadth_first() const;
	/// Return breadth-first end iterator.// TODO:
	breadth_first_queued_iterator end_breadth_first() const;
	/// Return sibling iterator to the first child of given node.// TODO:
	sibling_iterator begin(const iterator_base &) const;
	/// Return sibling end iterator for children of given node.
	sibling_iterator end(const iterator_base &) const;
	/// Return leaf iterator to the first leaf of the tree.
	leaf_iterator begin_leaf() const; // TODO:
	/// Return leaf end iterator for entire tree.
	leaf_iterator end_leaf() const; // TODO:
	/// Return leaf iterator to the first leaf of the subtree at the given node.
	leaf_iterator begin_leaf(const iterator_base &top) const; // TODO:
	/// Return leaf end iterator for the subtree at the given node.
	leaf_iterator end_leaf(const iterator_base &top) const; // TODO:
	...
	template <typename iter>
	iter next_at_same_depth(iter) const; // TODO:
