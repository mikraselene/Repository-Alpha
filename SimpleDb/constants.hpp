...
namespace database
{
    ...
    constexpr uint32_t LEN_SIZE = sizeof(uint);
    constexpr uint32_t ROW_SIZE = POS_SIZE + LEN_SIZE;
    ...
    constexpr off_t POS_OFFSET = 0;
    constexpr off_t LEN_OFFSET = POS_OFFSET + LEN_SIZE;
...
namespace btree_node
{
    ...
    constexpr uint32_t KEY_SIZE = KEY_LENGTH * sizeof(char); // TODO:
