...
void Languages()
{
	...
	auto indo_european = lang.append_child(head, "INDO-EUROPEAN LANGUAGES");
	{
		auto germanic = lang.append_child(indo_european, "Germanic Languages");
		{
			...
			{
				auto british_english = lang.append_child(english, "British English");
				auto american_english = lang.append_child(english, "American English");
			}
		...
		auto indo_iranian = lang.append_child(indo_european, "Indo-Iranian Languages");
		{
	...
	auto sino_tibetan = lang.append_child(head, "SINO-TIBETAN LANGUAGES");
	{
		...
		auto tibeto_burman = lang.append_child(sino_tibetan, "Tibeto-Burman Languages");
		{
...
#define ADD(xx) lang.append_child(it, xx)
	...
	lang.print();
	cout << "LCA(" << *a << ", " << *b << ") = " << *lang.lowest_common_ancestor(a, b) << endl;
